...
@section('heading_nav', 'New Author')
...
@section('main_content')
      <div class="card card-primary">
        ...
        <div class="card-body">
            <form action="{{ route('admin_author_section_add_submit') }}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <div class="image">
                                <img src="{{ asset('upload/img/user2-160x160.jpg') }}" style="width:300px;" alt="Author Image">
                            </div>
                        </div>
                        <div class="form-group">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('author_name') is-invalid @enderror" id="author_name" name="author_name" value="{{ old('author_name') }}" placeholder="Author Name">
                        </div>
                        <div class="form-group">
                            <label for="author_email">Email *</label>
                            <input type="text" class="form-control @error('author_email') is-invalid @enderror" id="author_email" name="author_email" placeholder="Author Email" value="{{ old('author_email') }}">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            data-on-color="success" data-on-text="Active" data-off-text="Pending" {{ old('author_status') == 'Active' ? 'checked' : '' }} >
                        </div>
                    </div>
                </div>
