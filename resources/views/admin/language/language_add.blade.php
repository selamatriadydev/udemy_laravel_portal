...
@section('heading', 'New Language')
@section('heading_nav', 'New Language')
...
@section('main_content')
      <div class="card card-primary">
        ...
        <div class="card-body">
            <form action="{{ route('admin_language_add_submit') }}" method="post">
                @csrf
                <div class="form-group">
                    <label for="language_name">Name *</label>
                    <input type="text" class="form-control @error('language_name') is-invalid @enderror" id="language_name" name="language_name" value="{{ old('language_name') }}" placeholder="Language name">
                </div>
                <div class="form-group">
                    <label for="language_short_name">Short Name *</label>
                    <input type="text" class="form-control @error('language_short_name') is-invalid @enderror" id="language_short_name" name="language_short_name"  value="{{ old('language_short_name') }}" placeholder="Language short name">
                ...
                <div class="form-group">
                    ...
                    data-on-color="success" data-on-text="YES" data-off-text="NO" {{ old('language_default') == 'Yes' ? 'checked' : '' }} >
                </div>
